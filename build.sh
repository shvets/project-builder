...
APP_BUNDLE_IDENTIFIER=com.rubikon.${PROJECT_NAME}
...
#${PLIST_BUDDY} -c "add :keychain-access-groups array" ${XCENT_FILE}
#${PLIST_BUDDY} -c "add :keychain-access-groups:0 string ${TEAM_IDENTIFIER}.${APP_BUNDLE_IDENTIFIER}" ${XCENT_FILE}
